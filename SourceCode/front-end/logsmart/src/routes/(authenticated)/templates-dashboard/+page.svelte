...
<div class="min-h-full" style="background-color: #F8F8F8;">
	...
	<div class="flex h-[calc(100vh-73px)]">
		...
		<div class="w-64 border-r-2 bg-white" style="border-color: #000100;">
			<div class="p-6">
				<h2 class="mb-4 text-2xl font-bold" style="color: #000100;">Templates</h2>
		...
		<div class="flex-1 overflow-auto p-6">
			<div class="mx-auto max-w-2xl">
				<h2 class="mb-6 text-center text-3xl font-bold" style="color: #A1A6B4;">Canvas</h2>

				<div class="rounded-lg border-2 bg-white p-8" style="border-color: #000100;">
					<h3 class="mb-6 text-xl font-bold" style="color: #000100;">New Log Template</h3>

					<div class="mb-8">
						<label
							for="log-title-input"
							class="mb-2 block text-lg font-bold"
							style="color: #A1A6B4;">Log Title</label
						>
						<input
							id="log-title-input"
							type="text"
		...
		<div class="w-64 border-l-2 bg-white" style="border-color: #000100;">
			<div class="p-6">
				<h2 class="mb-6 text-2xl font-bold" style="color: #000100;">Components</h2>

				<div class="space-y-3">
					{#each components as component}
						<div
							class="flex cursor-pointer items-center gap-3 border-2 px-4 py-3 hover:bg-gray-50"
							style="border-color: #000100;"
						>
							<div
