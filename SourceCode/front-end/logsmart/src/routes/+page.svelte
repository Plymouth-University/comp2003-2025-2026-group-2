<main class="bg-white">
	<section class="relative px-6 py-8" style="background-image: url('/src/lib/assets/banner.webp'); background-size: cover; background-position: center;">
	...
	<section class="border-t border-gray-300 bg-white px-6 py-12">
